...
// -----------------------------------------------------------------------------
function RusDateToDateTime(RDate: String; LMonthes: Boolean): TDateTime;
const Monthes: array[1..12] of string = ('янв', 'фев', 'мар', 'апр','мая','июн', 'июл', 'авг', 'сен', 'окт','ноя', 'дек');
const MonthesLong: array[1..12] of string = ('января', 'февраля', 'марта', 'апреля','мая','июня', 'июля', 'августа', 'сентября', 'октября','ноября', 'декабря');
var
    i: Integer;
