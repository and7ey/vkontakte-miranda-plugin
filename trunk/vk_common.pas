...
function RusDateToDateTime(RDate: string; LMonthes: boolean): TDateTime;
const
  Monthes: array[1..12] of string = ('€нв', 'фев', 'мар', 'апр', 'ма€', 'июн', 'июл', 'авг', 'сен', 'окт', 'но€', 'дек');
const
  MonthesLong: array[1..12] of string = ('€нвар€', 'феврал€', 'марта', 'апрел€', 'ма€', 'июн€', 'июл€', 'августа', 'сент€бр€', 'окт€бр€', 'но€бр€', 'декабр€');
var
  i:              integer;
