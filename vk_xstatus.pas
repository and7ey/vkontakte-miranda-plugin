 ...
 begin
   ...
   Begin
     ...
     Begin
       ...
       // <a href='id123456'>јлександр ‘амили€</a> Avs advanced to next round <span class="stTime">11:46</span><br/>
       if (Pos('покинул',StrTemp)=0) and
          ...
          (Pos('женилс€ на',StrTemp)=0) and // does it exist?
...
begin
  MsgCaption := String(Translate('ƒополнительный статус')) + ', ' + DBReadString(wParam, piShortName, 'XStatusTime', '00:00');
  MessageBox(0,
